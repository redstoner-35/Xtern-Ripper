...
该工程一共有九个文件夹，分别对应九套PCB。文件格式为Altium Designer 15。可以用LCEDA各个PCB作用如下：
...
这个工程包含120+元器件，五块PCB，而且有非常小且高引脚密度的QFN和SON-8芯片（最小封装2x2mm），大量的SOT323和0402原件，因此对焊接者的手工有非常高的要求。焊接工具方面需要的准备如下：
